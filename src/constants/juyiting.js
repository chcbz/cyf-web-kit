...
export const hallPhysicalScene = {
  ...
  interactiveZones: [
    { key: 'main', panel: 'chat', title: '忠义堂公议', subtitle: '厅前公议 / 众好汉', x: 50, y: 29, w: 28, h: 24, object: 'plaque', hitShape: 'plaque', tilt: 0 },
    { key: 'agents', panel: 'agents', title: '点将册', subtitle: '点将调遣', x: 25, y: 50, w: 28, h: 20, object: 'ledger', hitShape: 'ledger', tilt: -2 },
    { key: 'tasks', panel: 'tasks', title: '悬赏榜', subtitle: '榜文', x: 78, y: 44, w: 28, h: 28, object: 'notice-rack', hitShape: 'notice-board', tilt: 1 },
    { key: 'catalog', panel: 'catalog', title: '招贤令', subtitle: '遍请豪杰', x: 8, y: 72, w: 14, h: 34, object: 'banner-flag', hitShape: 'banner-flag', tilt: -3 },
    { key: 'library', panel: 'library', title: '案卷阁', subtitle: '查卷问典', x: 77, y: 76, w: 28, h: 28, object: 'scroll-shelf', hitShape: 'scroll-desk', tilt: -1 },
    { key: 'back', panel: null, title: '整装处', subtitle: '兵甲行囊', x: 69, y: 30, w: 27, h: 25, object: 'rear-gear', hitShape: 'gear-rack', tilt: 0 }
  ],
  patrolAnchors: [
