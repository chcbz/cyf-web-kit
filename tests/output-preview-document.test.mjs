...
assert.match(source, /const PREVIEW_REPRESENTATIONS = new Set\(\['EXTRACTED_TEXT', 'PAGED_IMAGE', 'SHEET_TEXT', 'PAGED_TEXT'\]\)/)
...
assert.match(source, /preview\.representation === 'SHEET_TEXT'/)
