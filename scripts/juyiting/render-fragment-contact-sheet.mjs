...
const SEAM_INSETS = [
  ...
  { title: 'D · east worktable crosses y=580 intact', x: 1470, y: 540, width: 194, height: 190 },
  { title: 'E · former broad west rect: owner pixels only', x: 0, y: 330, width: 570, height: 410 },
  { title: 'F · east worktable approved two-part owner', x: 1475, y: 550, width: 165, height: 180 },
  { title: 'G · southwest wall + two lantern owners', x: 0, y: 680, width: 430, height: 248 },
